...
- `CREATOR_PHASE5_MAX_TOKENS_RETRY` (ignored in code during testing flow; retry disabled, default would be 3000)
- `CREATOR_PHASE5_FALLBACK_EXPAND_PASSES` (ignored in code during testing flow; fallback disabled)
- `CREATOR_PHASE7_REPAIR_ATTEMPTS` (ignored in code during testing flow; repair disabled)
