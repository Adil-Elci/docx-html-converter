...
_LANGUAGE_INSTRUCTIONS: Dict[str, Dict[str, str]] = {
    "de": {
        "system": (
            ...
            "    \"refined_topic\": <string, das angepasste Article-Thema fuer den Gewinner>,\n"
            ...
            "- refined_topic ist das ARTIKEL-Thema, NICHT der Backlink-Anchor. Beispiel: Ziel verkauft Brillen, "
            "Publisher = Kinder-Magazin -> refined_topic = 'Kinderbrillen' (nicht 'guenstige Brillen').\n"
    ...
    "fr": {
        "system": (
            ...
            "    \"refined_topic\": <string, le sujet d'article ajuste>,\n"
            "    \"confidence\": <float 0.0-1.0>,\n"
            ...
            "- refined_topic = sujet d'ARTICLE, pas l'ancre du backlink.\n"
