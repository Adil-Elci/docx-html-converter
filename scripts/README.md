...
```bash
python3 scripts/import_tabular_to_db.py --config scripts/examples/publishing_site_credentials_by_url.example.json --dry-run
python3 scripts/import_tabular_to_db.py --config scripts/examples/publishing_site_credentials_by_url.example.json
```
...
The example config in `scripts/examples/` is ready for importing WordPress credentials by site URL.
